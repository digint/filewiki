...
sub update_vars
{
  ...
  if($page->{SRC_FILE} =~ m/$video_match/)
  {
    ...
    run_video_commands($page);

    # image source was generated by GALLERY_VIDEO_CMD_JPG
    $image_src = $page->{TARGET_DIR} . $page->{NAME} . '.jpg';
  }
